...
// errors
    ...
    fprintf( f, "#\n" );
    fprintf( f, "# > ./breport.sht <zmin> [zmax]\n" );
    fprintf( f, "\n" );
    fprintf( f, "\n" );
    fprintf( f, "if (($# == 1))\n" );
    fprintf( f, "then\n" );
    ...
    fprintf( f, "\n" );
    fprintf( f, "rm -f BlockNoMakes.txt\n" );
    fprintf( f, "touch BlockNoMakes.txt\n" );
    fprintf( f, "\n" );
    fprintf( f, "for lyr in $(seq $1 $last)\n" );
    fprintf( f, "do\n" );
    fprintf( f, "\techo $lyr\n" );
    ...
    fprintf( f, "\t\tdo\n" );
    fprintf( f, "\t\t\tif [ ! -e $jb/make.down ]\n" );
    fprintf( f, "\t\t\tthen\n" );
    fprintf( f, "\t\t\t\techo \"$jb\" >> BlockNoMakes.txt\n" );
    fprintf( f, "\t\t\tfi\n" );
    fprintf( f, "\t\tdone\n" );
    fprintf( f, "\tfi\n" );
    fprintf( f, "done\n" );
